# Markdown Table Generator — Convert TSV & CSV to MD Tables

> Convert spreadsheet cells, TSV, and CSV into beautifully aligned GitHub Markdown tables online. Fast, clean formatting, and 100% private.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/md-table-kit/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/md-table-kit/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/md-table-kit/](https://cig13zs.github.io/md-table-kit/) or install the offline Chrome Extension package.
...
Copy cells from Excel, Google Sheets, or paste CSV data. MD Table Kit converts the columns into aligned GitHub-flavored Markdown table syntax.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/md-table-kit.git
   ```
